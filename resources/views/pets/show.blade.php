...
<html>
    ...
    <body>
        ...
        <div id="zawartosc">
            <h2>Confirmation - Delete id: {{ $pet->id }}</h2>
            <form class="form-inline" action="<?=config('app.url'); ?>/pets/delete/{{ $pet->id }}" method="post">
                @csrf
                ...
                <p>
                    ...
                    <input id="breed" name="breed" value="{{ $pet->breed }}" readonly required>
                </p>
                <p>
                    <label for="name">Name:</label>
                    <input id="name" name="name" value="{{ $pet->name }}" readonly required>
                </p>
